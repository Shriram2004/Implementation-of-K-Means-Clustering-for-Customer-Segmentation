...
## Output:
### Dataset:
![K Means Clustering for Customer Segmentation](07.1.png)
### Dataset information:
![K Means Clustering for Customer Segmentation](07.4.png)
### Elbow method graph (wcss vs each iteration):
![K Means Clustering for Customer Segmentation](07.2.png)
### Cluster represnting customer segments-graph:
![K Means Clustering for Customer Segmentation](07.3.png)
